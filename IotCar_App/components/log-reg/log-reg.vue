<template>
	<view class="log-reg">
		<view class="log-reg-box">
			...
			<input class="loginfo" type="text" placeholder="请输入账号" v-model="logId" />
		...
		<view class="log-reg-box reg">
			...
			<input class="loginfo" type="text" placeholder="请输入账号" v-model="regId" />
			<input class="loginfo" type="text" placeholder="请输入昵称" v-model="regName" />
